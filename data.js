(function (root, factory) {
  ...
  const temples = [
    {
      ...
      tracks: {
        foundation: [
          { code: "G-F1", title: "支點之眼", summary: "辨認肘關節、二頭肌拉力與石球重力。", mission: "先判斷肘關節在前臂槓桿中的角色，再啟動機關檢查轉動證據。", skill: "辨認常見作用力", prerequisites: "讀圖", time: "30–60 秒", image: "assets/titans/biceps.webp", visual: "pivot", known: ["前臂托住石球", "肘關節是前臂轉動中心", "二頭肌在肘部附近斜向上拉前臂", "石球重力由球心鉛直向下"], control: control("顯示肘關節轉動證據", 0, 1, 0, 1, 1, "", "reveal"), prediction: prediction("在前臂的槓桿模型中，肘關節扮演哪一種角色？",[["pivot","支點"],["effort","施力點"],["load","阻力點"]]), reason: reason("為什麼肘關節是支點？",[["rotate","前臂繞它轉動"],["heavy","它最重"],["muscle","它會產生肌力"]]), explanation: "支點是物體轉動所繞的固定位置；在這個模型中，前臂繞肘關節轉動。", hint: "先找出姿勢改變時，哪個位置是旋轉中心。" },
          { code: "G-F2", title: "距離之力", summary: "同樣的力離支點越遠，轉動效果越明顯。", mission: "兩道石門使用相同推力，只有一種施力位置能更輕易轉動門軸。", skill: "比較力臂", prerequisites: "距離比較", time: "30–60 秒", image: "assets/titans/triceps.webp", visual: "lever-distance", known: ["兩次推力大小相同", "推力方向相同", "只改變施力點到支點的距離"], control: control("施力點距離", 10, 30, 10, 30, 5, "cm"), prediction: prediction("把施力點由 10 cm 移到 30 cm，轉動效果會如何？",[["increase","變大"],["same","不變"],["decrease","變小"]]), reason: reason("哪一項最能解釋觀察結果？",[["farther","同樣的力離支點更遠"],["mass","手臂質量增加"],["speed","推力速度一定變快"]]), explanation: "力的大小與方向不變時，作用位置離支點越遠，轉動效果越明顯。", hint: "想像推門時，你會推門把還是靠近鉸鏈的位置？" },
    ...
    },
    {
      ...
      tracks: {
        foundation: [
          { code:"C-F1",title:"誰跑得快",summary:"位置—時間圖越陡，物體運動越快。",mission:"兩列時空列車留下不同斜率的軌跡；判斷哪一列更快。",skill:"判讀位置—時間圖",prerequisites:"座標圖",time:"30–60 秒",image:"assets/chrono/time-1.webp",visual:"xt-slope",known:["橫軸為時間","縱軸為位置","比較相同時間內位置改變"],control:control("青色軌跡陡峭度",1,3,1,3,1,"級"),prediction:prediction("青色軌跡變得更陡時，青色列車的速度如何？",[["increase","變快"],["same","不變"],["decrease","變慢"]]),reason:reason("圖像證據是什麼？",[["more-position","相同時間內位置改變更多"],["higher","線畫得比較高所以質量大"],["color","青色代表高速"]]),explanation:"位置—時間圖的斜率代表速度；相同時間內位置改變越多，線越陡、速度越大。",hint:"固定一段相同的時間，比較兩條線上升多少。"},
    ...
    },
    {
      ...
      tracks:{
        ...
        advanced:[
          ...
          {code:"M-A4",title:"耗散封印",summary:"比較碰撞前後動能並求損失。",mission:"承接上一關：2 kg 石車以 6 m/s 撞上靜止 1 kg 石車，碰後共同速度 4 m/s。",skill:"碰撞能量分析",prerequisites:"動能、動量守恆",time:"90–160 秒",image:"assets/momentum/momentum-temple.png",visual:"momentum-calc-loss",known:["碰前動能 36 J","碰後總質量 3 kg","共同速度 4 m/s"],models:[option("loss","損失=K前−K後"),option("gain","損失=K後−K前"),option("momentum","損失=p前−p後")],inputs:[input("energy","動能損失","J",.1)],explanation:"碰後動能為 ½×3×4²=24 J，碰前為 ½×2×6²=36 J，因此 12 J 轉為內能、聲音與形變。",hint:"先分別計算碰撞前後的總動能，再取差值。"}
        ]
      }
    },
    {
    ...
    },
    {
      ...
      tracks:{
        foundation:[
          {code:"B-F1",title:"磁極之門",summary:"同名磁極相斥，異名磁極相吸。",mission:"轉動兩根磁柱，預測神門是閉合或彈開。",skill:"磁極交互作用",prerequisites:"方向",time:"30–60 秒",image:"assets/magnetic/magnetic-temple.png",visual:"magnetic-poles",known:["兩磁柱距離固定","只改變右柱朝向","忽略其他力"],control:control("右柱朝向",1,2,1,2,1,"式"),prediction:prediction("兩個 N 極相對時會如何？",[["repel","互相排斥"],["attract","互相吸引"],["none","沒有作用"]]),reason:reason("正確規則是什麼？",[["pole-rule","同名相斥、異名相吸"],["charge-rule","N 極必定帶正電"],["mass-rule","磁力只看質量"]]),explanation:"磁極遵循同名相斥、異名相吸；但 N、S 極不是可單獨分離的正負電荷。",hint:"不要把磁極與電荷直接畫上等號。"},
          {code:"B-F2",title:"洛倫茲羅盤",summary:"磁力同時垂直於速度與磁場。",mission:"讓正電粒子水平進入垂直紙面的磁場，判斷路徑。",skill:"磁力方向質性判斷",prerequisites:"三維方向",time:"45–75 秒",image:"assets/magnetic/magnetic-temple.png",visual:"magnetic-lorentz",known:["粒子帶正電","速度向右","磁場垂直紙面向內"],control:control("磁場強度",1,4,1,4,.5,"級"),prediction:prediction("正電粒子剛進入時受力方向為何？",[["up","向上"],["right","向右"],["into","向紙面內"]]),reason:reason("磁力與速度的關係是什麼？",[["perpendicular","磁力垂直速度，因此改方向不直接改速率"],["parallel","磁力永遠沿速度"],["zero","運動電荷永遠不受磁力"]]),explanation:"正電荷的磁力方向由 q v×B 決定；此例向上，且磁力垂直速度。",hint:"先用右手判斷 v×B；若是負電荷再反向。"},
    ...
    },
    {
      ...
      tracks:{
        ...
        advanced:[
          {code:"O-A1",title:"司乃耳之門",summary:"由折射率與入射角求折射角。",mission:"光由空氣 n₁=1.00 以 30° 入射玻璃 n₂=1.50。",skill:"n₁sinθ₁=n₂sinθ₂",prerequisites:"反三角函數",time:"75–140 秒",image:"assets/optics/optics-temple.png",visual:"optics-calc-snell",known:["n₁=1.00","n₂=1.50","θ₁=30°","角度由法線量起"],models:[option("snell","n₁sinθ₁=n₂sinθ₂"),option("linear","n₁θ₁=n₂θ₂"),option("cos","n₁cosθ₁=n₂cosθ₂")],inputs:[input("angle","折射角","°",.3)],explanation:"sinθ₂=(1/1.5)sin30°=1/3，所以 θ₂≈19.5°。",hint:"折射角應小於 30°，可先用質性判斷檢核。"},
  ...
  const histories = {
    ...
    optics:"「牛頓認為光的微粒進水會加速，惠更斯卻說波在水中變慢。」斯涅爾扶正法線。「折射不是裝飾，而是能判定兩種說法的實驗戰場。量角度、測速率，讓自然替理論裁決。」",
